...
def user_interaction():
    ...
    while(True):
        ...
        if select_mode == 1:
            search_query = input('Введите поисковой запрос \033[32mнапример водитель\033[0m: ')
            top_n = int(input('Введите количество вакансий для вывода в топ N \033[32mнапример 5\033[0m: '))
            filter_words = input('Введите ключевые слова для фильтрации вакансий \033[32mнапример Москва\033[0m: ').split()
